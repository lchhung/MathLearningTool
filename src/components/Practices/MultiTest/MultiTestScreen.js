...
import { MultiTestArrayData } from './MultiTestArrayData';
import { styles } from './MultiTestStyle';


export class MultiTestScreen extends Component {
  constructor(props) {
    super(props);

    var testData = MultiTestArrayData();
    this.state = {
      count: 0,
